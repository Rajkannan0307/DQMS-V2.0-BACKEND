...
// dashboardRouter.post("/getInspectionStatus/sendMail", verifyJWT, async (req, res) => {
//     // try {
//     //     const pool = await poolPromise;
...
//     //                 ?.map((e) => `<th style="font-size:14px; padding:8px;">${e?.inspection_name}</th>`).join("")}
//     //                 </tr>
//     //             </thead>
//     //             <tbody>
...
//     //     await Promise.all(plantRecord.map(async (e) => {
//     //         await handleMainAction(e?.plant_id, today)
//     //     }))
